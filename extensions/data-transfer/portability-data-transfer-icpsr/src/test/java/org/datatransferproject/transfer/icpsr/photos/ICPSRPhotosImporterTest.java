...
package org.datatransferproject.transfer.icpsr.photos;
...
public class ICPSRPhotosImporterTest {
  ...
  public void testImportSinglePhoto() throws Exception {
    ...
    ICPSRPhotosImporter icpsrPhotosImporter =
        new ICPSRPhotosImporter(monitor, client, jobStore, "http://icpsr.com", "exporter");
    icpsrPhotosImporter.importItem(UUID.randomUUID(), executor, authData, resource);
