...
package org.datatransferproject.transfer.videos;
...
public class ICPSRVideosImporterTest {
  ...
  public void setUp() {
    ...
    clientFactory = mock(ICPSRDataTransferClientFactory.class);
    executor = mock(IdempotentImportExecutor.class);
    authData = mock(TokenSecretAuthData.class);
    client = mock(ICPSRDataTransferClient.class);
  }

  @Test
  public void testNullData() throws Exception {
    ICPSRVideosImporter sut =
        new ICPSRVideosImporter(monitor, dataStore, streamProvider, clientFactory);
  ...
  public void testImportVideo() throws Exception {
    ...
    when(clientFactory.getOrCreateTransferClient(jobId, authData)).thenReturn(client);
